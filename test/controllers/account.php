	...
	*/
	function index() {
       ...
       // echo '<pre/>';print_r($business_countries);die();
		...
		$this->navigation->SidebarButton('<i class="fa fa-cog"></i> Settings</span>','settings/');
...
/*
  ...
  */
  ...
  function  upgrade()
   {
		$this->navigation->PageTitle('Upgrade');
		$this->load->model('client_model');
		$data = array('');

		$this->navigation->SidebarButton('<span class="btn btn-success new"><i class="fa fa-user"></i> Account</span>','account');
