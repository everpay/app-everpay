...
class Coupons extends Controller {
	...
	public function index()
	{
		...
		// sidebar
		$this->navigation->SidebarButton('<span class="section__btn section__btn--round"><i class="fa fa-plus"></i> Coupon</span>','coupons/add');
	...
	public function add()
	{
		...
		$this->navigation->PageTitle('Create New Coupon');
	...
	public function edit ($id = 0)
	{
		...
		$this->navigation->PageTitle('Edit Coupon');
		$plans = $this->plan_model->GetPlans($this->user->Get('client_id'), array('plan_type' => 'paid'));
