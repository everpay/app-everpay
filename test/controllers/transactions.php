...
// echo '<pre/>';print_r($this->dataset->data);die();
		...
		$this->navigation->SidebarButton('<span class="section__btn section__btn--round"><i class="fa fa-plus"></i> Charge</span>','transactions/create');
        ...
        $data['fees_today'] = round(($data['total_sales_of_the_week']) * 0.01 + (0.50 * $data['total_orders_today']), 2);

        if ($data['total_sales_of_the_week'] <= 0) {
            $data['fees_today'] = 0.00;
        }

        $data['net_today'] = round($data['total_sales_of_the_week'] - $data['fees_today'], 2);
	...
	function all_recurring ()
	{
		...
		// sidebar
		$this->navigation->SidebarButton('<button class="section__btn section__btn--round"> <i class="fa fa-plus"></i> New Charge</button>','transactions/create');
	...
	*/
	function create() {
		...
		$this->navigation->SidebarButton('<button class="section__btn section__btn--round"> <i class="fa fa-plus"></i> Customer </button>','customers/add');
	...
	*/
	function charge ($id) {
		...
		// sidebar
                $this->navigation->SidebarButton('<button class="section__btn section__btn--round"> <i class="fa fa-plus"></i> Charge</button>','transactions/create/');
	...
	*/
	function recurring ($id = FALSE) {
		...
		// sidebar
                ...
                $this->navigation->SidebarButton('<button class="section__btn section__btn--round"> <i class="fa fa-plus"></i> Charge</button> New Charge</button>','transactions/create/');
