...
class Plans extends Controller {
	...
	function index()
	{
		$this->navigation->PageTitle(' Recurring Plans');
		...
		$this->navigation->SidebarButton('<span class="btn btn-success"> <i class="fa fa-plus"></i>Plan</span>','plans/new_plan');
	...
	*/
	...
	{
		 // sidebar
  		$this->navigation->SidebarButton('<span class="btn btn-default"> <i class="fa fa-eye"></i> View Plans</span>','plans/');  
     
                $this->navigation->PageTitle('New Recurring Plan');
