...
class Recipients extends Controller {
	...
	* Manage recipients
	*
	* Lists all active recipients, with optional filters
	*/
	function index()
	{
		
		$this->navigation->PageTitle('Recipients');
		...
		$this->load->view(branded_view('cp/recipients.php'));
	}
	...
	* Add customer
	*
	* Add New recipients address, etc.
	*
	* @return string view
	*/
		function new_recipient () {
		$this->load->model('customer_model');
		$this->navigation->PageTitle('New Recipients');
        $this->notices->SetNotice($this->lang->line('customers_added'));
	    $this->load->view(branded_view('cp/recipients_new.php'));
	}
