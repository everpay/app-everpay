...
<header class="section-header hidden"><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
              <div class="container-960 center">
<div class="copywriting">
<div class="heading" data-animation="fadeInUp" data-animation-delay=".2s">
	
<h1 class="margin-none">Products</strong></h1>
<a class="btn btn-success btn-sm pull-right" style="color:#fff; margin-right:30px;" href="<?=site_url('/products/add');?>"><span class="fa fa-plus-circle"></span> New Product </a>
</br>
</div>
</div>
             </div>
...
if (!empty($this->dataset->data)) {
	...
	?>
		<tr>
			...
			<td><?=$row['name'];?></td>
      <td class="options">
        <a class="btn btn-primary btn-xs" href="<?=site_url('products/edit/' . $row['id']);?>"><span class="fa fa-edit"></span> edit</a>
      </td>
		</tr>
	<?php
$l =isset($_REQUEST['req']);
