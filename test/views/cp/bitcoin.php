...
a.getstarted__list__item:hover{background-color:rgba(146,214,244,.1)}
.getstarted__list__item{opacity:.6;border:none}
...
<h1 class="margin-none">Add <strong class="text-primary">Bitcoin Address</strong></h1>
</div>
</div>
             </div>
</header>
