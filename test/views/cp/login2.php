...
<link href="<?=branded_include('css/elektropay.css');?>" rel="stylesheet" type="text/css" media="screen" />
...
body {    
    background-image: url(http://127.0.0.1:8080/elektropay.com/assets/app/img/back.jpg)!important;
...
#signin {    
    background-image: url(http://127.0.0.1:8080/elektropay.com/assets/front/img/back.jpg)!important;
	 background-repeat: no-repeat;
	     background-attachment: fixed!important;
    -webkit-background-size: cover;
            background-size: cover!important;
...
<script type="text/javascript" src="<?=branded_include('js/jquery.js');?>"></script>
...
<!-- App Javascript -->
<script type="text/javascript" src="<?=branded_include('js/smoothScroll.js');?>"></script>	
<script type="text/javascript" src="<?=branded_include('js/app.min.js');?>"></script>
...
<body id="signin" class="clear">
		...
		<a class="logo" href="//everpayinc.com">
	        <img src="https://res.cloudinary.com/lmj6rf6tz/image/upload/c_scale,w_96/v1443806855/sq_logo_djmpxo.png" class="text-center" style="padding:2px;" title="Login To Everpay" alt="Everpay" >
	</a>
...
<input class="form-control form-control-solid placeholder-no-fix" type="password" autocomplete="off" id="password" placeholder="Password" name="password" required/>
		...
		<div class="fields">
					...
					<div style="clear:both" style="height: 25px;"></div>
		</div>
			
				<div class="actions submit">
					<input type="submit" class="btn-primary btn-lg" name="login_button" value="Sign in to your account" />
				</div>
		</form>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-3 col-sm-3">
				...
				<p><small>Copyright © 2016 Everpay.com</small></p>
			</div>

			<div class="col-md-2 col-md-offset-1 col-sm-3">
				<ul>
					<li>
						<a href="http://127.0.0.1:8080/elektropay.com/careers.html/">
						Jobs
			...
			<div class="col-md-2 col-md-offset-1 col-sm-3">
				...
				<ul>
					<li>
						<a href="mailto:hello(at)elektropay.com">hello(at)elektropay.com</a>
					</li>
				</ul>
			</div>
			...
			<div class="col-md-2 col-md-offset-1 col-sm-3">
				...
				<ul>
				<li>
						<a href="#"><hr class="separator" style="height:20px;"></a>
					</li>
					<li>
						<a href="http://127.0.0.1:8080/elektropay.com/status/">Server Status</a>
					</li>
				</ul>
