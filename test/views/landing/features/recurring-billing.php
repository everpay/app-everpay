                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12 text-center slide-text">
                                ...
                                <h1 class="animated slideInLeft delay-2">Recurring Billing</h1>
                                <div class="divide15"></div>
                    ...
                    <div class="box-pad-top">
                        ...
                        <div class="col-md-4 no-margin-left">
                            <div class="section-side-body">
                                Fetch rates in real time
Need to dynamically change your prices? balanced.js will be able to let your know how many Euros to charge, moment to moment. <a href="http://everpayinc.com/support/hc/en-us/articles/200173030-Do-I-need-to-be-PCI-compliant-">PCI compliant</a>.
                            </div>
