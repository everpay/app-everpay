...
class tables {
	...
	function __construct($table_prefix) {
		...
		$this->permission_groups	 	= $this->table_prefix . 'permission_groups';
		$this->permission_tasks	 		= $this->table_prefix . 'permission_tasks';
		...
		$this->tables = array(
			...
			'permission_groups'			=> $this->table_prefix . 'permission_groups',
			'permission_tasks'			=> $this->table_prefix . 'permission_tasks',
