...
<link rel="shortcut icon" href="https://everpayinc.com/favicon.ico">
...
<link href="https://everpayinc.com/assets/app/css/bootstrap.min.css" rel="stylesheet" type="text/css" media="screen" />

        <!-- flex slider css -->
        <link href="https://everpayinc.com/assets/app/css/flexslider.css" rel="stylesheet" type="text/css" media="screen" />
        <!-- animated css  -->
        <link href="https://everpayinc.com/assets/app/css/animate.css" rel="stylesheet" type="text/css" media="screen" />
        <!--google fonts-->
        

        <!--Revolution slider css-->
     <link href="https://everpayinc.com/assets/app/js/rs-plugin/css/settings.css" rel="stylesheet" type="text/css" media="screen" />
     <link href="https://everpayinc.com/assets/app/css/rev-style.css" rel="stylesheet" type="text/css" media="screen" />
	<!-- Style -->

        <!-- custom css (blue color by default) -->
    <link href="https://everpayinc.com/assets/app/css/front-style.css" rel="stylesheet" type="text/css" media="screen" />
        
        <!--owl carousel css-->
<link href="https://everpayinc.com/assets/app/css/owl.carousel.css" rel="stylesheet" type="text/css" media="screen" />
<link href="https://everpayinc.com/assets/app/css/owl.theme.css" rel="stylesheet" type="text/css" media="screen" />
        <!--mega menu -->
<link href="https://everpayinc.com/assets/app/css/yamm.css" rel="stylesheet" type="text/css" media="screen" />
        <!--popups css-->
<link href="https://everpayinc.com/assets/app/css/magnific-popup.css" rel="stylesheet" type="text/css" media="screen" />
...
<!-- HEADER -->
            ...
            <div class="container">
                <div class="top-bar">
                    <div class="pull-left sample-1right">
                        <a><i class="fa fa-phone"></i> Any questions? Call us: <span class="colored-text">+ 1-866-357-6616</span> </a> 
                         <a><i class="fa fa-envelope"></i> Mail us: <span class="colored-text">support@everpayinc.com</span> </a>
                    </div>
        ...
        <!--navigation -->
        <!-- Static navbar -->
        <!--<div id="undefined-sticky-wrapper" class="sticky-wrapper is-sticky" style="height: 25px;">-->
 <div class="navbar navbar-inverse navbar-fixed-top transparent-header yamm" role="navigation"style="background: #05101b;">
            <div class="container">
...
<!--mega menu-->
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">Features  <i class="fa fa-angle-down"></i></a>
                           ...
                           <li><a href="https://everpayinc.com/mobile_processing">Mobile Processing </a></li>
                                                </ul>
                               ...
                               <li><a href="https://everpayinc.com/Fraud_Protection">Fraud Prevention</a></li>
                             ...
                             <li><a href="https://everpayinc.com/zoanga_app">Zoanga</a></li>
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <ul class="nav mega-vertical-nav">  
<li><a href="https://everpayinc.com/go_shop">Online POS Store </a></li> 
...
<footer id="footer" style="margin-top;-10px;">
            <div class="container">
              ...
              <h3><img src="https://everpayinc.com/assets/app/img/logo/white.png" class="attachment-full" alt="Everpay"></h3>
                            <p>
Everpay Corporation, typically abbreviated to Everpay, is making everday commerce simple process and is a provider of payment management solutions.                               
          ...
          <ul class="list-inline">
            <li class="copyright">&COPY; 2015 Everpayinc.com - All Rights Reserved.</li>
 ...
 <li style="margin-top: 4px;"><iframe allowtransparency="true" frameborder="0" scrolling="no" src="//platform.twitter.com/widgets/follow_button.html?screen_name=everpay" style="width:120px; height:20px;"></iframe></li>
          </ul>
</span>
                        </div>
                    </div>
...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.1/js/bootstrap.min.js"></script>
    ...
    <script type="text/javascript" src="https://everpayinc.com/assets/app/js/jquery.easing.1.3.min.js"></script>
        <!--sticky header-->
<script type="text/javascript" src="https://everpayinc.com/assets/app/js/jquery.sticky.js"></script>
        <!--flex slider plugin-->
<script type="text/javascript" src="https://everpayinc.com/assets/app/js/jquery.flexslider-min.js"></script>
        <!--parallax background plugin-->
<script type="text/javascript" src="https://everpayinc.com/assets/app/js/jquery.stellar.min.js"></script>
  
        <!--image loads plugin -->
<script type="text/javascript" src="https://everpayinc.com/assets/app/js/jquery.imagesloaded.min.js"></script>
        
        <!--digit countdown plugin-->
        <script src="https://cdnjs.cloudflare.com/ajax/libs/waypoints/2.0.5/waypoints.min.js"></script>
        <!--digit countdown plugin-->
<script type="text/javascript" src="https://everpayinc.com/assets/app/js/jquery.counterup.min.js"></script>
        <!--on scroll animation-->
<script type="text/javascript" src="https://everpayinc.com/assets/app/js/wow.min.js"></script>
        <!--owl carousel slider-->
<script type="text/javascript" src="https://everpayinc.com/assets/app/js/owl.carousel.min.js"></script>
        <!--popup js-->
<script type="text/javascript" src="https://everpayinc.com/assets/app/js/jquery.magnific-popup.min.js"></script>
        <!--you tube player-->
<script type="text/javascript" src="https://everpayinc.com/assets/app/js/jquery.mb.YTPlayer.min.js"></script>
        <!--customizable plugins-->

<script type="text/javascript" src="https://everpayinc.com/assets/app/js/everpay-custom.js"></script>
<script type="text/javascript" src="https://everpayinc.com/assets/app/js/back-to-top.js"></script>
...
Contact::getObject()->address           = '<strong>'
    ...
    . 'Canada<br />'
    . '<b><abbr title="Phone">P:</abbr> (800) 566-6003</b>';
/**
