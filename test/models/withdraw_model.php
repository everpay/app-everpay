...
* Withdraw Types
* 1 = To Bank Account
* 2 = To Credit Card On File
* 3 = To BTC Wallet address
...
class Withdraw_model extends Model
{
	...
	*
	* @return array Containing new Transaction ID, BTC ADDRESS and encrypted Key
	*/
	function NewWithdraw($client_id, $params, $first_client = FALSE)
	{
		...
		// Make sure the transaction ID is not already used
