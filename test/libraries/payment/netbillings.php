...
var $settings;
	...
	{
		$settings = array();
		$settings['name'] = 'NetBillings';
		$settings['class_name'] = 'netbillings';
		$settings['external'] = FALSE;
		$settings['no_credit_card'] = TRUE;
		$settings['description'] = 'Netbillings specializes in high risk merchant acquiring and is a payments provider of online credit card processing services available for international merchants.';
		$settings['is_preferred'] = 1;
		$settings['setup_fee'] = '$1750';
		$settings['monthly_fee'] = '$99';
		$settings['transaction_fee'] = '9.75% + $1.25';
		$settings['purchase_link'] = 'https://everpayinc.com/#';
...
function Process($request, $order_id)

	{
		...
		$ch = curl_init("https://admin.netbillings.com/api/cc.php");
