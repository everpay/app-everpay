...
var $settings;
	...
	{
		$settings = array();
		$settings['name'] = 'check2pay';
		$settings['class_name'] = 'check2pay';
		$settings['external'] = FALSE;
		$settings['no_credit_card'] = TRUE;
		$settings['description'] = 'check2pay specializes in high risk merchant acquiring and is a payments provider of online credit card processing services available for international merchants.';
...
function Process($request, $order_id)

	{
		...
		$ch = curl_init("https://admin.check2pay.com/api/cc.php");
