...
/**
 * Base Echeck payment gateway class
 *
...
abstract class AbstractGateway implements GatewayInterface
{
     ...
     */
    public function supportsDeleteEcheck()
    {
        return method_exists($this, 'deleteEcheck');
    }

    /**
     * Supports UpdateEcheck
     *
     * @return boolean True if this gateway supports the update() method
     */
    public function supportsUpdateEcheck()
    {
        return method_exists($this, 'updateEcheck');
    }
