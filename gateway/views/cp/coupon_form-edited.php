...
<form class="form validate well" id="form_coupon" method="post" action="<?=$form_action;?>">
    ...
    <fieldset>
        ...
        <ul class="form">
            ...
            <li ><label  for="coupon_name">Coupon Name</label>
<input type="text" class="col-xs-10 col-sm-5 required" style="width:250px" name="coupon_name" rel="" id="coupon_name" value="<?= isset($coupon) ? $coupon['name'] : '' ?>"></li>
            ...
            <li><label  for="coupon_code">Coupon Code</label><input type="text" class="col-xs-10 col-sm-5 required" name="coupon_code" rel="" id="coupon_code" value="<?= isset($coupon) ? $coupon['code'] : '' ?>"></li>
            ...
            <li>
            	...
            	<input type="text" class="col-xs-10 col-sm-5" style="width:6em" name="coupon_max_uses" rel="" id="coupon_max_uses" value="<?= isset($coupon) ? $coupon['max_uses'] : '' ?>">
...
<span class="help-button" data-rel="popover" data-trigger="hover" data-placement="left" data-content="More details." title="" data-original-title=" The maximum number of customers that can use the coupon.">?</span>
    ...
    <fieldset id="fs_reduction">
        ...
        <ul class="form coupon_reduction">
			...
			<input type="text" class="col-xs-10 col-sm-5 mark_empty" style="width:6em" name="coupon_trial_length" rel="in days" id="coupon_trial_length" value="<?= isset($coupon) ? $coupon['trial_length'] : '' ?>">
<span class="help-button" data-rel="popover" data-trigger="hover" data-placement="left" data-content="More details." title="" data-original-title="The amount of the discount.">?</span>
...
<input type="submit" class="btn btn-primary btn-lg btn-block" name="add_coupon" value="Save Coupon" />
</div>
</form>
