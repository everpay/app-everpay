...
<form class="form-horizontal" id="form_email" method="post" action="<?=site_url($form_action);?>">
<fieldset>
...
<li><p></p></li>
		<li>
			<label for="email_body" class="lead full">Email Body</label><? if ($form['is_html'] == '0') { ?> <a href="#" id="make_html">use HTML format</a><? } ?>
			<input type="hidden" class="form-control" name="is_html" id="is_html" value="<?=$form['is_html'];?>" autocomplete="off" />
		</li>
		<li>
