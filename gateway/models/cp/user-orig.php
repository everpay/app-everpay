            ...
            if(intval($two_step_enable) !== 1) {
                ...
                if(intval($two_step_verified) === 1) {
                    ...
                    if(!$result) {
                        ...
                        // $CI->notices->SetNotice('Enter this Code : '.$code.'(dev purpose)');
                    } else {
                        // $CI->notices->SetNotice('Enter this Code : '.$result->code.'(dev purposes)');
                    }
            ...
            if(intval($two_step_enable) !== 1) {
                ...
                if(intval($two_step_verified) === 1) {
                    ...
                    if(!$result) {
                        ...
                        $this->send_verification_email($code, $email);
                        $CI->notices->SetNotice($CI->lang->line('notice_code_sent'));
                        // $CI->notices->SetNotice('Enter this Code : '.$code.'(development purpose)');
                    } else {

                        $CI->two_step_model->UpdateCode($code, $client_id);
                        $this->send_verification_email($code, $email);
                        $CI->notices->SetNotice($CI->lang->line('notice_code_sent'));
                        // $CI->notices->SetNotice('Enter this Code : '.$result->code.'(development purpose)');
                    }
