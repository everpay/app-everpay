...
' . $xml_params . '
    ...
    */
    function TableHead () {
    	...
    	if ($this->filters == true) {
    		$output .= '<div class="col-sm-12"><div class="row"style="margin-bottom:2px;"><div class="col-md-4"><div class="dataset_actions">' . $actions . '</div></div><div class="col-md-8"><div class="apply_filters"><input type="submit" name="" value="Filter Dataset" />&nbsp;&nbsp;<input id="reset_filters" class="btn btn-danger" type="reset" name="" value="Clear Filters" /> &nbsp;&nbsp;<input id="dataset_export_button" type="button" name="" class="btn btn-info" value="Export" /></div></div><div class="col-md-2"></div></div>';
    	}

    	$output .= '</div>
    				<table class="dataset table table-striped table-bordered table-hover dataTable" cellpadding="0" cellspacing="0">
    				<thead><tr>';
