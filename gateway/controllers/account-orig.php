...
class Account extends Controller {
	...
	*/
	function post () {
		...
		if ($this->input->post('bank_acc_type') == '') {
			$this->notices->SetError('Bank Account Type is a required field.');
			$error = true;
		}
		...
		if ($this->input->post('bank_acc_name') == '') {
			$this->notices->SetError('Bank Account Name is a required field.');
			$error = true;
		}
